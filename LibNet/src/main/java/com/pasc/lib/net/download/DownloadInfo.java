...
public class DownloadInfo implements Serializable {
    ...
    public DownloadInfo(String downloadUrl,
                        String fileName, boolean resumePoint) {
        this (0, downloadUrl, fileName, null, null, resumePoint);

    }

    public DownloadInfo(String downloadUrl,
                        String fileName, String fileSavePathRoot, boolean resumePoint) {
        this (0, downloadUrl, fileName, fileSavePathRoot, null, resumePoint);

    }

    public DownloadInfo(int id, String downloadUrl,
                        String fileName, String fileSavePathRoot, String icon, boolean resumePoint) {
        this.id = id;
    ...
    public DownloadInfo clone() {
        DownloadInfo info = new DownloadInfo ()
                .id (id).downloadState (downloadState).downloadUrl (downloadUrl).fileName (fileName)
