...
import com.pasc.lib.net.converter.AnnotatedConverterFactory;
import com.pasc.lib.net.converter.EmptyToNullConverter;
import com.pasc.lib.net.converter.ReqParamConverterFactory;
...
public class RetrofitServiceCreatorFactory implements ServiceCreatorFactory {
  ...
  public RetrofitServiceCreatorFactory(NetManager netManager) {
    ...
    defaultRetrofit = new Retrofit.Builder().baseUrl(baseUrl)
            ...
            .addConverterFactory(GsonConverterFactory.create(netManager.globalConfig.gson))
